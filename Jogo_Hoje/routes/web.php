...
Route::get('userinsert', UserInsert::class)->middleware('auth')->name('user-insert');
...
Route::post('inserir-jogador', [EquipeController::Class, 'inserir'])->middleware('auth')->name('inserir-jogador');
