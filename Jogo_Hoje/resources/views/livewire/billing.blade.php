                                    ...
                                    <div class="card">
                                        <div class="card-header mx-4 p-3 text-center">
                                            <div
                                                ...
                                                <i class="material-icons opacity-10">saldo_da_conta</i>
                                            </div>
                                        </div>
                                        <div class="card-body pt-0 p-3 text-center">
                                            <h6 class="text-center mb-0">Salário</h6>
                                            <span class="text-xs">Pertencer interativo</span>
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="card">
                                        <div class="card-header mx-4 p-3 text-center">
                                            <div
                                                class="icon icon-shape icon-lg bg-gradient-primary shadow text-center border-radius-lg">
                                                <i class="material-icons opacity-10">carteira_de_saldo_de_conta</i>
                                            </div>
                                        </div>
                                        <div class="card-body pt-0 p-3 text-center">
                                            <h6 class="text-center mb-0">Paypal</h6>
                                            <span class="text-xs">Pagamento de Freelancers</span>
                                            <hr class="horizontal dark my-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 text-end">
                                            <a class="btn bg-gradient-dark mb-0" href="javascript:;"><i
                                                    class="material-icons text-sm">adicionar</i>&nbsp;&nbsp;Adicionar novo cartão</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <ul class="list-group">
                                <li
                                    ...
                                    <div class="d-flex flex-column">
                                        <h6 class="mb-1 text-dark font-weight-bold text-sm">01 de Março, 2020</h6>
                                        <span class="text-xs">#MS-415646</span>
                                    </div>
                                    <div class="d-flex align-items-center text-sm">
                                        $180
                                        <button class="btn btn-link text-dark text-sm mb-0 px-0 ms-4"><i
                                                class="material-icons text-lg position-relative me-1">imagem_como_pdf</i>
                                            PDF</button>
                                    </div>
                                </li>
                                <li
                                ...
                                <li
                                    class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                                    <div class="d-flex flex-column">
                                        <h6 class="text-dark mb-1 font-weight-bold text-sm">05 de abil, 2020</h6>
